...
@Route(value = "/game/rounds/two", layout = MainLayoutWithDrawer.class)
public class RoundTwo extends VerticalLayout {
    ...
    public void beforeEnter() {
        ...
        if(connectToDatabase.checkRoundLive("sports").equals("false")){
    ...
    private void confirmSubmit() {
        ConnectToDatabase connectToDatabase = new ConnectToDatabase();
        Answers answers = new Answers(1, one.getValue(), two.getValue(), three.getValue(), four.getValue(), five.getValue(), six.getValue(), seven.getValue(), eight.getValue(), nine.getValue(), ten.getValue(), eleven.getValue(), twelve.getValue(), teamName, "Sports");
        connectToDatabase.submitAnswers(answers);
