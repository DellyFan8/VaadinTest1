...
@Route(value = "/game/rounds/three", layout = MainLayoutWithDrawer.class)
public class RoundThree extends VerticalLayout {
    ...
    public void beforeEnter() {
        ...
        if(connectToDatabase.checkRoundLive("pop").equals("false")){
    ...
    private void confirmSubmit() {
        ConnectToDatabase connectToDatabase = new ConnectToDatabase();
        Answers answers = new Answers(1, one.getValue(), two.getValue(), three.getValue(), four.getValue(), five.getValue(), six.getValue(), seven.getValue(), eight.getValue(), nine.getValue(), ten.getValue(), eleven.getValue(), twelve.getValue(), teamName, "Pop");
